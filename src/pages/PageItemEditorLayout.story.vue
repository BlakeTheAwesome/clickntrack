...
import StoryComponent from './PageItemEditorLayout.vue'
...
const gridItems = ref(trackerStore.allGridItems)
</script>

<template>
  <Story>
    <StoryComponent v-model:gridItems="gridItems" :presets="presets" v-on="logEmits(StoryComponent)" />
  </Story>
</template>
